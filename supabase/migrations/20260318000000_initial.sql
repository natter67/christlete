...
-- ─────────────────────────────────────────
-- SEED: Real prayer groups
-- ─────────────────────────────────────────
insert into public.prayer_groups (name, type, description, sport, is_private, invite_code) values
  ...
  ('Track & Cross Country Faith', 'team', 'For distance and track athletes who run for more than just a finish line.', 'Track', false, 'TRACK1');
